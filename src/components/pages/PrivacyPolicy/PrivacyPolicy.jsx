...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Trinity Financing</title>
        <meta name="description" content="Read Trinity Financing's Privacy Policy to understand how we collect, use, and protect your personal information." />
      </Helmet>
